...
*/
    ...
    public function getInfosadministrateur($login, $mdp){
        ...
        public function getProduct ($id_product) {
            $req = "select * from produit where id = '$id_product'";
             $res = PdoLafleur::$monPdo->query($req);
        ...
        public function modProduct ($data) {
            ...
            $prix = $data['Prix'];
            $req = "update produit set prix='$prix', description='$description' where id = '$id'";
             $res = PdoLafleur::$monPdo->query($req);
             $product = $res->fetchAll();
             return $product;
        }
            public function supProduct ($id_product, $categorie) {
          $req = "DELETE FROM produit where id = '$id_product'";
             $res = PdoLafleur::$monPdo->query($req);
            header("Location: index.php?uc=administrer&action=voirProduits&categorie=".$categorie);
